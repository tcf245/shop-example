    ...
    <div class="container">
        ...
        <div class="col-md-9 product-price1">
            ...
            <div class="check-out">
                    ...
                    <div class="in-check">
                        ...
                        <c:forEach items="${cart.goods}" var="goods">
                            <ul class="cart-header">
                                <%--<div class="close1"><a href="deleteOne">Delete</a></div>--%>
                                <li class="ring-in"><a href="${goods.id}"><img src="${goods.image}"
                                                                               class="img-responsive" alt=""></a>
                                </li>
                                <li><span>${goods.goodsName}</span></li>
                                <li><span>$ ${goods.price}</span></li>
                                <li><span>In Stock</span></li>
                                <li><div><a href="checkout/${goods.id}" class="add-cart cart-check">CHECK OUT</a></div>
                                    <div><a href="delete/${goods.id}" class="add-cart cart-check">Delete</a></div>
                                </li>
                                <div class="clearfix"></div>
                            </ul>
                        </c:forEach>
                ...
                <a href="deleteAll" class="add-cart cart-check">DeleteAll</a>
                <a href="checkout" class="add-cart cart-check">CHECK OUT</a>
            </div>
            </form>
...
<div class="footer">
    <div class="container">
        ...
        <div class="clearfix"></div>
        <p class="footer-class">Copyright &copy; 2015.Company name All rights reserved.More Templates <a href="blog"
                                                                                                         target="_blank"
                                                                                                         title="丶CyanBean">丶CyanBean</a>
            - Collect from <a href="blog" title="丶CyanBean" target="_blank">丶CyanBean</a></p>
    </div>
</div>
<!---->
</body>
